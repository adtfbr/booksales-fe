              ...
              <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tbody>
                  ...
                  <tr key={book.id} className="border-b dark:border-gray-700">
                    ...
                    <td className="px-4 py-3">{book.genre ? book.genre.name : getGenreName(book.genre_id)}</td>
                    <td className="px-4 py-3">{book.author ? book.author.name : `Author #${book.author_id}`}</td>
